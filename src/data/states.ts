...
export const states: StateData[] = [
  ...
  },
  {
    ...
    maxWeeks: 26,
    waitingWeek: false,
    metaDescription: "Michigan: $530/week max, 26 weeks, no waiting week -- benefits start immediately. File Michigan.gov MiWAM the week you separate. Dependent allowance available.",
  ...
  },
  {
    ...
    maxWeeks: 26,
    waitingWeek: true,
    metaDescription: "Minnesota: $948/week max, 26 weeks, 1-week wait. File uimn.org the week you separate. Must also register on MinnesotaWorks.net or payments are held.",
  ...
  },
  {
    ...
    maxWeeks: 26,
    waitingWeek: true,
    metaDescription: "Mississippi: $235/week max, 26 weeks, 1-week wait. Among the lowest caps nationally. File mdes.ms.gov the week you're laid off. Weekly certifications required.",
  ...
  },
  {
    ...
    maxWeeks: 20,
    waitingWeek: true,
    metaDescription: "Missouri: $320/week max, only 20 weeks total. 1-week wait. One of the shorter durations nationally. File UInteract at labor.mo.gov the week you're laid off.",
  ...
  },
  {
    ...
    metaDescription: "New Mexico: $598/week max, 26 weeks, 1-week wait. File jobs.state.nm.us immediately. Register NM Workforce Connection same day or payments are held."
  },
  {
    name: "New York",
    slug: "new-york",
    ...
    metaDescription: "New York: $869/week max, 26 weeks, 1-week wait. File dol.ny.gov the week you separate. Must log 3 job contacts per week or that week's benefit is lost."
  },
  {
    name: "North Carolina",
    slug: "north-carolina",
    ...
    metaDescription: "North Carolina: $450/week, only 12 weeks total. 1-week wait. File des.nc.gov the week you're laid off. Tied with FL for shortest UI cap in the U.S."
  },
  {
    name: "North Dakota",
    slug: "north-dakota",
    ...
    metaDescription: "North Dakota: $786/week max, 26 weeks, 1-week wait. File jobsnd.com the week you separate. Register Job Service ND immediately or payments are blocked."
  },
  {
    name: "Ohio",
    slug: "ohio",
    ...
    metaDescription: "Ohio: $600/week max ($842 with dependents), 26 weeks, 1-week wait. File unemployment.ohio.gov the week you separate. List all dependents at filing."
  },
  {
    name: "Oklahoma",
    slug: "oklahoma",
