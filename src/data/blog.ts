...
**Working while on unemployment is smart and encouraged.** States want you to get back on your feet. Just be transparent about your earnings and you'll be fine.
  ...
  {
    slug: "severance-and-unemployment",
    title: "Got Severance? Here's How It Actually Affects Your Unemployment Benefits",
    description:
      "Severance pay can delay your unemployment, but the rules are messier than most online guides admit. Here's what actually drives the outcome.",
    date: "2026-04-29",
    content: `
...
**New York.** Severance does not affect your weekly benefit if the first payment is made 30 or more days after your last day of employment. If the first payment lands within 30 days of separation, it can delay benefits for the period the severance covers.

**Texas.** Treatment depends on the type. Wages in lieu of notice and certain unilaterally offered severance disqualify you for the period covered. Negotiated severance, contractual severance, and settlement payments typically do not affect eligibility. The state issues an individual decision after you file.

**California.** Severance pay is generally not considered wages for unemployment purposes. Lump-sum payments tied to a release of claims usually do not delay benefits. Salary-continuation severance can delay benefits while it is being paid.

**Florida.** Severance delays your Reemployment Assistance for a number of weeks equal to the severance amount divided by your average weekly wage at that employer, rounded down. So a $20,000 severance with a $2,000 average weekly wage would delay benefits by 10 weeks.
