        ...
        <Phase
          ...
          body={
            <>
              ...
              <p>
                Seven states have no waiting week (Connecticut, Iowa, Maryland,
                Michigan, Nevada, New Jersey, Rhode Island). In those states,
                paid benefits begin the first eligible week.
              </p>
            </>
          }
          actions={[
