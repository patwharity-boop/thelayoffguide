...
export const metadata: Metadata = {
  ...
  description:
    "47.9% of Q1 2026 tech layoffs were attributed to AI. If you were displaced by automation, here's the honest read on which roles are vulnerable, what's actually being hired, and where to pivot.",
  keywords: [
    "AI layoffs 2026",
  ...
  openGraph: {
    title: "Laid Off Because of AI? What the Data Shows and What to Do (2026)",
    description:
      "47.9% of Q1 2026 tech cuts were AI-attributed. The honest read on what's vulnerable, what's hiring, and where to pivot.",
    type: "article",
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-12">
      ...
      <article className="prose-custom text-gray-700 leading-relaxed space-y-6">
        ...
        <p>
          You are not imagining the pattern. According to Challenger, Gray &amp; Christmas, 47.9 percent of tech-sector job cuts in Q1 2026 were attributed to AI or automation in the public statements made by employers. That is the highest share since the firm started tracking the reason in 2023. Roughly 113,000 tech workers were affected year-to-date as of the end of March.
        </p>
        ...
        <p>
          There is a real and persistent gap between AI-related job demand and AI-related supply. Forrester Research estimated in early 2026 that US employers are looking to fill roughly 275,000 AI-adjacent positions that are not getting filled, and that the gap is widening, not closing. These are not pure machine-learning research roles. They are practical:
        </p>
        ...
        <p>
          Anecdotally, three patterns are working. Skillsyncer's 2026 displaced-worker tracker, which surveys people 90 days after a tech layoff, lines up with what is showing up on LinkedIn and in posts to r/layoffs:
        </p>
        ...
        <div className="mt-10 pt-8 border-t border-gray-200 text-sm text-gray-500">
          ...
          <ul className="list-disc pl-6 mt-2 space-y-1">
            <li>Challenger, Gray &amp; Christmas, Job Cut Report Q1 2026 (AI-attributed cuts as 47.9% of tech sector layoffs).</li>
            <li>Forrester Research, 2026 AI Labor Market Outlook (US AI-adjacent job gap of ~275,000 unfilled roles).</li>
            <li>Skillsyncer, 2026 Displaced Tech Worker Tracker (90-day post-layoff outcomes survey).</li>
          </ul>
        </div>
      </article>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        description: "47.9% of Q1 2026 tech cuts were AI-attributed. The honest read on what's vulnerable, what's hiring, and where to pivot.",
