      ...
      <section className="mb-12">
        ...
        <div className="space-y-6">
          {[
            ...
            { slug: "how-to-get-past-ats", title: "How to Get Past ATS: Resume Optimization for Laid-Off Workers in 2026", description: "Sent 50 applications and gotten 3 callbacks? ATS software filtered your resume before any human saw it. Here's how to fix it, with a layoff-specific angle.", date: "2026-05-07" },
