    ...
    <div className="mx-auto max-w-4xl px-4 py-12">
      ...
      <section className="mb-12">
        ...
        <div className="space-y-6">
          {[
            { slug: "gaming-layoffs-unemployment", title: "Laid Off from a Game Studio? Unemployment for Game Devs (2026)", description: "Xbox and game studio cuts in 2026 left thousands figuring out UI. Employee vs contractor, which state applies, severance rules, and what Washington state Xbox workers need to file.", date: "2026-08-31" },
            ...
            { slug: "tipped-income-unemployment", title: "Tipped Income and Unemployment: What Restaurant and Service Workers Need to Know", description: "Your unemployment benefit is based on W-2 wages, not what you pocketed in tips. Here’s how tip reporting affects your base period, what to do if wages look low, and how to file.", date: "2026-08-24" },
            { slug: "negotiate-with-creditors-after-layoff", title: "How to Negotiate With Creditors Before You Miss a Payment", description: "Losing income doesn't mean you have to miss payments and wreck your credit. How to call your mortgage servicer, credit card company, and lenders before you fall behind, what to say, and which debt-relief offers to avoid.", date: "2026-08-04" },
